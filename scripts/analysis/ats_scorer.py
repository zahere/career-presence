...
class ATSScorer:
    ...
    TECH_KEYWORDS = {
        # Languages
        "python", "go", "golang", "rust", "c++", "cpp", "java", "scala",
        ...
        "aws", "gcp", "azure", "cloud",
        "ci/cd", "cicd", "github actions", "argocd", "jenkins",
        "mlops", "devops", "sre",
        ...
        # Concepts
        "distributed systems", "microservices", "api", "rest",
    ...
    def __init__(self, keywords_db_path: Optional[str] = None):
        """
